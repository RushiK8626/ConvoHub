    ...
    <div className="profile-page">
      ...
      {loading ? (
        <div className="profile-content">
          <p style={{ textAlign: 'center', padding: '40px', color: '#999' }}>Loading profile...</p>
        </div>
      ) : error ? (
        <div className="profile-content">
          <p style={{ textAlign: 'center', padding: '40px', color: '#ff4444' }}>{error}</p>
        </div>
      ) : (
        <div className="profile-content">
                ...
                <span className="avatar-emoji-large">
                  {profileData.fullName 
                    ? profileData.fullName.split(' ').length >= 2 
                      ? (profileData.fullName.split(' ')[0][0] + profileData.fullName.split(' ')[profileData.fullName.split(' ').length - 1][0]).toUpperCase()
